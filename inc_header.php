...
<body>
    <nav>
        <div class="wrapper">
            <div class="logo"><a href='<?php echo url_dasar() ?>'>Raihan Mediatech.</a></div>
            <div class="menu">
                <ul>
                    <li><a href="<?php echo url_dasar() ?>#home">Beranda</a></li>
                    <li><a href="<?php echo url_dasar() ?>#courses">Tentang Kami</a></li>
                    <li><a href="<?php echo url_dasar() ?>#tutors">Produk dan Layanan</a></li>
                    <li><a href="<?php echo url_dasar() ?>#partners">Partners</a></li>
                    <li><a href="<?php echo url_dasar() ?>#contact">Kontak Kami</a></li>
                    <li>
